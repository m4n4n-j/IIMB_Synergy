                ...
                {slots.length > 0 ? (
                    <div className="bg-green-50 border border-green-200 rounded-xl p-4 flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-green-700 mt-1">We've recorded your availability. Matches will be announced this Sunday at 6 PM.</p>
                        </div>
                    </div>
                ) : (
                    <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start gap-3">
                        ...
                        <div>
                            <h3 className="font-bold text-blue-900">Set your availability</h3>
                            <p className="text-sm text-blue-700 mt-1">Add at least one slot to get matched with peers this week.</p>
                        </div>
                    </div>
                )}
            </div>
